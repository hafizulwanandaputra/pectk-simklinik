...
class PasienModel extends Model
{
    ...
    protected $allowedFields = ['id_dokter', 'nama_pasien', 'no_mr', 'no_registrasi', 'nik', 'jenis_pasien', 'tempat_lahir', 'tanggal_lahir', 'agama_pasien', 'no_hp_pasien', 'alamat_pasien', 'provinsi', 'kota', 'kecamatan', 'desa', 'tgl_pendaftaran'];
