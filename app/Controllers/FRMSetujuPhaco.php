...
class FRMSetujuPhaco extends BaseController
{
    ...
    public function pasienlist()
    {
        ...
        if (session()->get('role') == 'Admin' || session()->get('role') == 'Dokter' || session()->get('role') == 'Admisi') {
            ...
            // LEFT JOIN ke medrec_form_persetujuan_tindakan_phaco
            $builder->join('medrec_form_persetujuan_tindakan_phaco', 'rawat_jalan.nomor_registrasi = medrec_form_persetujuan_tindakan_phaco.nomor_registrasi', 'left');

            // Hanya ambil data yang belum ada di medrec_form_persetujuan_tindakan_phaco
            $builder->where('medrec_form_persetujuan_tindakan_phaco.nomor_registrasi IS NULL');
    ...
    public function export($id)
    {
        ...
        if (session()->get('role') == 'Admin' || session()->get('role') == 'Dokter' || session()->get('role') == 'Admisi') {
            ...
            if ($form_persetujuan_tindakan) {
                ...
                $html = view('dashboard/frmsetujuphaco/form', $data);
                $filename = 'output-form-persetujuan-tindakan-phaco.pdf';
