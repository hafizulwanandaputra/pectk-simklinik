...
<div class="d-flex justify-content-start align-items-center">
    <a class="fs-5 me-3 text-body-emphasis" href="<?= base_url('/lpoperasikatarak'); ?>"><i class="fa-solid fa-arrow-left"></i></a>
    ...
    <?php if ($previous): ?>
        <a class="fs-6 mx-2 text-body-emphasis" href="<?= site_url('lpoperasikatarak/details/' . $previous['id_lp_operasi_katarak']) ?>" data-bs-toggle="tooltip" data-bs-placement="bottom" data-bs-title="<?= $previous['nomor_registrasi']; ?> • <?= $previous['no_rm'] ?> • <?= $previous['nama_pasien']; ?>"><i class="fa-solid fa-circle-arrow-left"></i></a>
    <?php else: ?>
        <span class="fs-6 mx-2 text-body-emphasis" style="cursor: no-drop; opacity: .5;" data-bs-toggle="tooltip" data-bs-placement="bottom" data-bs-title="Tidak ada laporan operasi katarak sebelumnya"><i class="fa-solid fa-circle-arrow-left"></i></span>
    <?php endif; ?>
    <?php if ($next): ?>
        <a class="fs-6 mx-2 text-body-emphasis" href="<?= site_url('lpoperasikatarak/details/' . $next['id_lp_operasi_katarak']) ?>" data-bs-toggle="tooltip" data-bs-placement="bottom" data-bs-title="<?= $next['nomor_registrasi']; ?> • <?= $next['no_rm'] ?> • <?= $next['nama_pasien']; ?>"><i class="fa-solid fa-circle-arrow-right"></i></a>
    <?php else: ?>
        <span class="fs-6 mx-2 text-body-emphasis" style="cursor: no-drop; opacity: .5;" data-bs-toggle="tooltip" data-bs-placement="bottom" data-bs-title="Tidak ada laporan operasi katarak berikutnya"><i class="fa-solid fa-circle-arrow-right"></i></span>
    <?php endif; ?>
</div>
                    ...
                    <div class="no-fluid-content">
                        <nav class="nav nav-pills flex-nowrap overflow-auto rounded-3 bg-gradient border p-1 transparent-blur">
                            <?php foreach ($listRawatJalan as $list) : ?>
                                <a class="nav-link py-1 rounded-2 <?= ($activeSegment === $list['id_lp_operasi_katarak']) ? 'active activeLink' : '' ?>" href="<?= base_url('lpoperasikatarak/details/' . $list['id_lp_operasi_katarak']); ?>">
        ...
        <div class="no-fluid-content">
            ...
            <div class="mb-3">
                ...
                <div class="mb-2">
                    <div class="form-floating">
                        <input type="text" class="form-control" id="operator" name="operator" value="" autocomplete="off" dir="auto" placeholder="operator" readonly list="dokter_operator_list">
                ...
                <div class="mb-2">
                    <div class="form-floating">
                        <input type="text" class="form-control" id="asisten" name="asisten" value="" autocomplete="off" dir="auto" placeholder="asisten" list="asistenList">
                        <label for="asisten">Asisten<span class="text-danger">*</span></label>
                        <div class="invalid-feedback"></div>
                        <datalist id="asistenList">
                ...
                <div class="mb-2">
                    <div class="form-floating">
                        ...
                        <label for="operator">Anestesiologis<span class="text-danger">*</span></label>
                        <div class="invalid-feedback"></div>
            ...
            <div>
                ...
                <div class="d-grid gap-2 d-lg-flex justify-content-lg-end mb-3">
                    <button class="btn btn-body  " type="button" onclick="window.open(`<?= base_url('lpoperasikatarak/export/' . $lp_operasi_katarak['id_lp_operasi_katarak']) ?>`)"><i class="fa-solid fa-print"></i> Cetak Form</button>
