            ...
            if (data.total === 0) {
                ...
                data.lp_operasi_katarak.forEach(function(lp_operasi_katarak) {
                    ...
                    const tanggal_operasi = lp_operasi_katarak.tanggal_operasi ?
                        lp_operasi_katarak.tanggal_operasi + ' ' + lp_operasi_katarak.jam_operasi :
                        `<em>Belum ada</em>`;
                    ...
                    <li class="list-group-item <?= (session()->get('role') != 'Admisi') ? 'border-top-0' : ''; ?> pb-3 pt-3">
                        <div class="d-flex">
                            <div class="align-self-center w-100">
                                <h5 class="card-title d-flex date justify-content-start">
                                    ...
                                    <span class="ms-1 align-self-center">${lp_operasi_katarak.nama_pasien}</span>
                                </h5>
                                    <h6 class="card-subtitle mb-2">
                                        ${lp_operasi_katarak.nomor_registrasi} • ${lp_operasi_katarak.no_rm}<br>${jenis_kelamin}
                                    </h6>
                                    <div class="card-text">
                                        <div style="font-size: 0.75em;">
                        ...
                        <?php endif; ?>
                        <?php if (session()->get('role') != 'Admisi') : ?>
                            <button type="button" class="btn btn-danger btn-sm bg-gradient  delete-btn" data-id="${lp_operasi_katarak.id_lp_operasi_katarak}" data-name="${lp_operasi_katarak.nama_pasien}" data-date="${lp_operasi_katarak.nomor_registrasi}" ${delete_today}>
