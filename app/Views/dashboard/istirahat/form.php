            ...
            <div style="padding: 1cm;">
                ...
                <div class="box">
                    <div style="padding-right: 0.25cm; padding-left: 0.25cm;">
                        ...
                        <p>Pada pemeriksaan saat ini, pasien tersebut menderita sakit mata. Oleh karena itu, pasien tersebut perlu diberikan istirahat selama <?= $durasi_istirahat ?> (<?= $istirahat['durasi_teks'] ?>) hari mulai tanggal <?= $tanggal_mulai ?> s.d. <?= $tanggal_selesai ?>.</p>
