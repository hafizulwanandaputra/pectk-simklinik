...
<div class="d-flex justify-content-start align-items-center">
    ...
    <div class="flex-fill text-truncate">
        <div class="d-flex flex-column">
            ...
            <div class="fw-medium lh-sm" style="font-size: 0.75em;"><?= ($pembelianobat['merek'] == '') ? '<em>Tanpa Merek</em>' : $pembelianobat['merek']; ?> • <?= $pembelianobat['nama_supplier'] ?> • <?= $pembelianobat['tgl_pembelian'] ?></div>
        </div>
    </div>
