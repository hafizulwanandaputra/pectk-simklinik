            ...
            <tbody>
                <?php if ($transaksi['dokter'] != 'Resep Luar') : ?>
                    ...
                    <tr class="outline-border">
                        ...
                        <th class="outline-border" style="width: 60%; vertical-align: top; padding-top: 2px; padding-bottom: 0; padding-left: 2px; padding-right: 2px; text-align: left;">
                            Deskripsi
                        </th>
                ...
                <tr>
                    ...
                    <th colspan="2" class="outline-border" style="vertical-align: top; padding-top: 2px; padding-bottom: 0; padding-left: 2px; padding-right: 2px; text-align: right;">
