...
<div class="d-flex justify-content-start align-items-center">
    <a class="fs-6 me-3 text-success-emphasis" href="<?= base_url('/transaksi'); ?>"><i class="fa-solid fa-arrow-left"></i></a>
    <div class="flex-fill text-truncate">
        <div class="d-flex flex-column">
            <div class="fw-medium fs-6 lh-sm"><?= $headertitle; ?></div>
            <div class="fw-medium" style="font-size: 0.75em;"><?= $transaksi['no_kwitansi'] ?></div>
        </div>
    </div>
