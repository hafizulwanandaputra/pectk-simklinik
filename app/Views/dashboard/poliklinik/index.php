                    ...
                    <div class="no-fluid-content">
                        <div class="d-flex flex-row gap-2">
                            ...
                            <div class="input-group input-group-sm flex-grow-1">
                                <input type="search" class="form-control form-control-sm " id="externalSearch" placeholder="Cari nama ruangan poliklinik">
                            </div>
                        </div>
                    </div>
                </li>
                ...
                <table id="tabel" class="table table-sm table-hover m-0 p-0" style="width:100%; font-size: 0.75rem;">
                    <thead>
                        <tr class="align-middle">
                            ...
                            <th scope="col" style="background-color: var(--bs-card-cap-bg); border-bottom-width: 2px;">Nama Ruangan</th>
                ...
                },
                {
                    ...
                    render: function(data, type, row) {
                        ...
                        return `<div class="btn-group" role="group">
                                    <button class="btn btn-outline-body text-nowrap  edit-btn" style="--bs-btn-padding-y: 0.15rem; --bs-btn-padding-x: 0.5rem; --bs-btn-font-size: 1em;" data-id="${row.id_poli}" data-bs-toggle="tooltip" data-bs-title="Edit"><i class="fa-solid fa-pen-to-square"></i></button>
                                    <button class="btn btn-outline-danger text-nowrap   delete-btn" style="--bs-btn-padding-y: 0.15rem; --bs-btn-padding-x: 0.5rem; --bs-btn-font-size: 1em;" data-id="${row.id_poli}" data-name="${row.nama_poli}" data-bs-toggle="tooltip" data-bs-title="Hapus" ${deletedisabled}><i class="fa-solid fa-trash"></i></button>
                                </div>`;
                    }
                },
                {
