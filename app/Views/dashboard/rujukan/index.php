            ...
            <div class=" rounded">
                <?php if (session()->get('role') != 'Admisi') : ?>
                    <div class="d-grid gap-2">
                        <button id="collapseList" class="btn btn-primary btn-sm   rounded-bottom-0" type="button" data-bs-toggle="collapse" data-bs-target="#RujukanFormContainer" aria-expanded="false" aria-controls="RujukanFormContainer">
            ...
            if (data.total === 0) {
                ...
                data.rujukan.forEach(function(rujukan) {
                    ...
                    const dokter_rujukan = rujukan.dokter_rujukan ?
                        `<span class="isian-teks">${rujukan.dokter_rujukan}</span>` :
                    ...
                    <li class="list-group-item <?= (session()->get('role') != 'Admisi') ? 'border-top-0' : ''; ?> pb-3 pt-3">
                        <div class="d-flex">
                            <div class="align-self-center w-100">
                                <h5 class="card-title d-flex date justify-content-start">
                                    ...
                                    <span class="ms-1 align-self-center w-100 overflow-hidden"><span style="height: 1em;" class="isian-teks lh-1 fw-medium">${rujukan.nama_pasien}</span></span>
                                </h5>
                                    <h6 class="card-subtitle mb-2">
                                        <span class="isian-teks lh-1 fw-medium">${rujukan.nomor_registrasi} • ${rujukan.no_rm}</span><br>${jenis_kelamin}
                                    </h6>
                                    <div class="card-text">
                                        <div style="font-size: 0.75em;">
                                                    <div class="mb-0 row g-1 align-items-center">
                                                        ...
                                                        <div class="overflow-hidden col date">
                                                            <span class="isian-teks date">${rujukan.waktu_dibuat}</span>
                                                        </div>
                                                    </div>
                                                    <div class="mb-0 row g-1 align-items-center">
                                                        <div class="overflow-hidden col-5">
                                                            <span class="fw-medium">Dokter Rujukan</span>
                                                        </div>
                                                        <div class="overflow-hidden col date">
                                                            ${dokter_rujukan}
                                                        </div>
                                                    ...
                                                    <div class="mb-0 row g-1 align-items-center">
                                                        <div class="overflow-hidden col-5">
                                                            <span class="fw-medium">Alamat Rujukan</span>
                                                        </div>
                                                        <div class="overflow-hidden col date">
                        ...
                        <div class="d-grid gap-2 d-flex flex-wrap justify-content-end">
                        <?php if (session()->get('role') != 'Admisi') : ?>
                            <button type="button" class="btn btn-body btn-sm  " onclick="window.location.href = '<?= base_url('rujukan/details') ?>/${rujukan.id_rujukan}';">
                        ...
                        <?php endif; ?>
                        <?php if (session()->get('role') != 'Admisi') : ?>
                            <button type="button" class="btn btn-danger btn-sm   delete-btn" data-id="${rujukan.id_rujukan}" data-name="${rujukan.nama_pasien}" data-date="${rujukan.nomor_registrasi}">
