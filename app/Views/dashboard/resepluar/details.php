...
<div class="d-flex justify-content-start align-items-center">
    <a class="fs-5 me-3 text-body-emphasis" href="<?= base_url('/resepluar'); ?>"><i class="fa-solid fa-arrow-left"></i></a>
    ...
    <?php if ($previous): ?>
        <a class="fs-6 mx-2 text-body-emphasis" href="<?= site_url('resepluar/detailresep/' . $previous['id_resep']) ?>" data-bs-toggle="tooltip" data-bs-placement="bottom" data-bs-title="<?= $previous['id_resep'] ?> • <?= ($previous['nama_pasien'] == NULL) ? 'Anonim' : $previous['nama_pasien']; ?> • <?= $previous['tanggal_resep'] ?>"><i class="fa-solid fa-circle-arrow-left"></i></a>
    <?php else: ?>
    ...
    <?php endif; ?>
    <?php if ($next): ?>
        <a class="fs-6 mx-2 text-body-emphasis" href="<?= site_url('resepluar/detailresep/' . $next['id_resep']) ?>" data-bs-toggle="tooltip" data-bs-placement="bottom" data-bs-title="<?= $next['id_resep'] ?> • <?= ($next['nama_pasien'] == NULL) ? 'Anonim' : $next['nama_pasien']; ?> • <?= $next['tanggal_resep'] ?>"><i class="fa-solid fa-circle-arrow-right"></i></a>
    <?php else: ?>
