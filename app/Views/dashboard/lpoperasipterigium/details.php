                    ...
                    <div class="no-fluid-content">
                        <nav class="nav nav-pills flex-nowrap overflow-auto rounded-3 bg-gradient border p-1 transparent-blur">
                            <?php foreach ($listRawatJalan as $list) : ?>
                                <a class="nav-link py-1 rounded-2 <?= ($activeSegment === $list['id_lp_operasi_pterigium']) ? 'active activeLink' : '' ?>" href="<?= base_url('lpoperasipterigium/details/' . $list['id_lp_operasi_pterigium']); ?>">
        ...
        <div class="no-fluid-content">
            ...
            <div>
                ...
                <div class="d-grid gap-2 d-lg-flex justify-content-lg-end mb-3">
                    <button class="btn btn-body  " type="button" onclick="window.open(`<?= base_url('lpoperasipterigium/export/' . $lp_operasi_pterigium['id_lp_operasi_pterigium']) ?>`)"><i class="fa-solid fa-print"></i> Cetak Form</button>
