            ...
            <div class=" rounded">
                <?php if (session()->get('role') != 'Admisi') : ?>
                    <div class="d-grid gap-2">
                        <button id="collapseList" class="btn btn-primary btn-sm   rounded-bottom-0" type="button" data-bs-toggle="collapse" data-bs-target="#FRMSetujuFormContainer" aria-expanded="false" aria-controls="FRMSetujuFormContainer">
            ...
            if (data.total === 0) {
                ...
                data.form_persetujuan_tindakan.forEach(function(form_persetujuan_tindakan) {
                    ...
                    const pemberi_informasi = form_persetujuan_tindakan.pemberi_informasi ?
                        `<span class="isian-teks">${form_persetujuan_tindakan.pemberi_informasi}</span>` :
                    ...
                    const penerima_informasi = form_persetujuan_tindakan.penerima_informasi ?
                        `<span class="isian-teks">${form_persetujuan_tindakan.penerima_informasi}</span>` :
                        `<span class="isian-teks opacity-50 fst-italic user-select-none">Belum ada</span>`;
                    ...
                    <li class="list-group-item <?= (session()->get('role') != 'Admisi') ? 'border-top-0' : ''; ?> pb-3 pt-3">
                        <div class="d-flex">
                            <div class="align-self-center w-100">
                                <h5 class="card-title d-flex date justify-content-start">
                                    ...
                                    <span class="ms-1 align-self-center w-100 overflow-hidden"><span style="height: 1em;" class="isian-teks lh-1 fw-medium">${form_persetujuan_tindakan.nama_pasien}</span></span>
                                </h5>
                                    <h6 class="card-subtitle mb-2">
                                        <span class="isian-teks lh-1 fw-medium">${form_persetujuan_tindakan.nomor_registrasi} • ${form_persetujuan_tindakan.no_rm}</span><br>${jenis_kelamin}
                                    </h6>
                                    <div class="card-text">
                                        <div style="font-size: 0.75em;">
                                                    <div class="mb-0 row g-1 align-items-center">
                                                        <div class="overflow-hidden col-5">
                                                            <span class="fw-medium">Tanggal Persetujuan</span>
                                                        </div>
                                                    ...
                                                    <div class="mb-0 row g-1 align-items-center">
                                                        <div class="overflow-hidden col-5">
                                                            <span class="fw-medium">Pemberi Informasi</span>
                                                        </div>
                                                        <div class="overflow-hidden col date">
                                                            ${pemberi_informasi}
                                                        </div>
                                                    ...
                                                    <div class="mb-0 row g-1 align-items-center">
                                                        <div class="overflow-hidden col-5">
                                                            <span class="fw-medium">Penerima Informasi</span>
                                                        </div>
                        ...
                        <div class="d-grid gap-2 d-flex flex-wrap justify-content-end">
                        <?php if (session()->get('role') != 'Admisi') : ?>
                            <button type="button" class="btn btn-body btn-sm  " onclick="window.location.href = '<?= base_url('frmsetujuanestesi/details') ?>/${form_persetujuan_tindakan.id_form_persetujuan_tindakan_anestesi}';">
                                <i class="fa-solid fa-circle-info"></i> Detail
                            </button>
                        <?php endif; ?>
                        <?php if (session()->get('role') == 'Admisi') : ?>
                            <button type="button" class="btn btn-body btn-sm  " onclick="window.open('<?= base_url('frmsetujuanestesi/export') ?>/${form_persetujuan_tindakan.id_form_persetujuan_tindakan_anestesi}');">
                                <i class="fa-solid fa-print"></i> Cetak
                            </button>
                        <?php endif; ?>
                        <?php if (session()->get('role') != 'Admisi') : ?>
                            <button type="button" class="btn btn-danger btn-sm   delete-btn" data-id="${form_persetujuan_tindakan.id_form_persetujuan_tindakan_anestesi}" data-name="${form_persetujuan_tindakan.nama_pasien}" data-date="${form_persetujuan_tindakan.nomor_registrasi}">
