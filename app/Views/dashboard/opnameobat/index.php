            ...
            <div class=" rounded">
                <form id="opnameObatForm" enctype="multipart/form-data">
                    <div class="d-grid gap-2">
                        <button type="submit" id="addButton" class="btn btn-primary btn-sm   rounded-bottom-0">
    ...
    async function fetchOpnameObat() {
        ...
        try {
            ...
            <li class="list-group-item border-top-0 pb-3 pt-3">
                ...
                <hr>
                <div class="d-grid gap-2 d-flex flex-wrap justify-content-end">
                    <button type="button" class="btn btn-body btn-sm  " onclick="window.location.href = '<?= base_url('opnameobat/detailopnameobat') ?>/${opname_obat.id_opname_obat}';">
                        <i class="fa-solid fa-circle-info"></i> Detail
                    </button>
                    <button type="button" class="btn btn-danger btn-sm   delete-btn" data-id="${opname_obat.id_opname_obat}" data-name="${opname_obat.apoteker}" data-date="${opname_obat.tanggal}">
