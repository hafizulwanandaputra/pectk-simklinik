        ...
        <div class="box">
            ...
            <div style="padding-left: 0.25cm; padding-right: 0.25cm;">
                <table class="table" style="width: 100%; margin-bottom: 4px; border: 1px solid black; border-collapse: collapse;">
                    <thead>
                        <tr>
                            <th rowspan="2" style="width: 0%; vertical-align: middle; padding-top: 3px; padding-left: 0.125cm; padding-right: 0.125cm; border: 1px solid black;">
                                Tanggal
                            </th>
                            <th rowspan="2" style="width: 0%; vertical-align: middle; padding-top: 3px; padding-left: 0.125cm; padding-right: 0.125cm; border: 1px solid black;">
                                Unit
                            </th>
                            <th rowspan="2" style="width: 50%; vertical-align: middle; padding-top: 3px; padding-left: 0.125cm; padding-right: 0.125cm; border: 1px solid black;">
                                Informasi/Edukasi Tentang
                            </th>
                            <th colspan="2" style="width: 0%; vertical-align: middle; padding-top: 3px; padding-left: 0.125cm; padding-right: 0.125cm; border: 1px solid black;">
                                Edukator
                            </th>
                            <th colspan="2" style="width: 0%; vertical-align: middle; padding-top: 3px; padding-left: 0.125cm; padding-right: 0.125cm; border: 1px solid black;">
                        ...
                        <tr>
                            <th style="width: 0%; vertical-align: middle; padding-top: 3px; padding-left: 0.125cm; padding-right: 0.125cm; border: 1px solid black;">
                                Nama dan Profesi
                            </th>
                            <th style="width: 0%; vertical-align: middle; padding-top: 3px; padding-left: 0.125cm; padding-right: 0.125cm; border: 1px solid black;">
                                TTD
                    ...
                    <tbody>
                        <?php foreach ($edukasi_evaluasi as $evaluasi) : ?>
                            <tr>
                                <td style="width: 0%; vertical-align: middle; padding-top: 3px; padding-left: 0.125cm; padding-right: 0.125cm; border: 1px solid black; white-space: nowrap;">
                                    <?= date('Y-m-d', strtotime($evaluasi['waktu_dibuat'])) ?>
                                </td>
                                <td style="width: 0%; vertical-align: middle; padding-top: 3px; padding-left: 0.125cm; padding-right: 0.125cm; border: 1px solid black;">
                                    <?= $evaluasi['unit'] ?>
                                </td>
                                <td style="width: 50%; vertical-align: middle; padding-top: 3px; padding-left: 0.125cm; padding-right: 0.125cm; border: 1px solid black;">
