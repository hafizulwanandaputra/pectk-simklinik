                ...
                <div class="no-fluid-content">
                    <nav class="nav nav-underline flex-nowrap overflow-auto">
                        <?php foreach ($listRawatJalan as $list) : ?>
                            <a class="nav-link py-1 <?= ($activeSegment === $list['id_rawat_jalan']) ? 'active activeLink' : '' ?>" href="<?= base_url('rawatjalan/optik/' . $list['id_rawat_jalan']); ?>">
    ...
    <div class="px-3 mt-3">
        <div class="no-fluid-content">
            ...
            <div id="empty-placeholder" class="my-3 text-center">
                <h1 style="font-size: 7rem;"><i class="fa-solid fa-glasses"></i></h1>
