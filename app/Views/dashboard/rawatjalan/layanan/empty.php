        ...
        <div class="no-fluid-content">
            ...
            <div id="empty-placeholder" class="my-3">
                ...
                <?php if ($rawatjalan['transaksi'] == 1) : ?>
                    <div class="text-muted">Tidak ada layanan pada rawat jalan ini</div>
                <?php else : ?>
                    <?php if (session()->get('role') == 'Dokter') : ?>
                        <?php if ($rawatjalan['dokter'] != session()->get('fullname')) : ?>
                            <div class="text-muted">Layanan hanya bisa ditambahkan sesuai dengan dokter yang diberikan saat pendaftaran atau petugas kasir.</div>
...
<script>
    $(document).ready(function() {
        ...
        <?php if ($rawatjalan['transaksi'] == 0) : ?>
            $(document).on('click', '#addLayananBtn', function(ə) {
                ə.preventDefault();
                $('#addLayananForm').submit();
                $('#loadingSpinner').show();
                $('#addLayananBtn').prop('disabled', true).html(`
