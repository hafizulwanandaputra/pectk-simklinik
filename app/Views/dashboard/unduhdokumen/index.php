...
<main class="main-content-inside px-3 pt-3">
    <div class="no-fluid-content">
        ...
        <ul class="list-group shadow-sm  mb-3">
            <li class="list-group-item p-1 list-group-item-action">
                <div class="d-flex align-items-start">
                    <a href="<?= base_url('/assets/files/Kartu Berobat PECTK.pdf'); ?>" class="stretched-link download-btn" style="min-width: 3rem; max-width: 3rem; text-align: center;" target="_blank">
        ...
        <ul class="list-group shadow-sm  mb-3">
            <li class="list-group-item p-1 list-group-item-action">
                <div class="d-flex align-items-start">
                    <a href="<?= base_url('/assets/files/Resep Obat PECTK.pdf'); ?>" class="stretched-link download-btn" style="min-width: 3rem; max-width: 3rem; text-align: center;" target="_blank">
