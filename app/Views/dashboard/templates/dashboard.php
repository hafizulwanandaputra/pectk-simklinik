                    ...
                    <div class="offcanvas offcanvas-end bg-success-subtle text-success-emphasis shadow-sm" tabindex="-1" id="userOffcanvas" aria-labelledby="userOffcanvasLabel" style="border-left: var(--bs-offcanvas-border-width) solid var(--bs-success-border-subtle);">
                        ...
                        <div class="offcanvas-body p-1">
                            ...
                            <div class="text-center w-100 lh-sm mb-3">
                                <span><?= session()->get('fullname'); ?><br><span style="font-size: 10pt;">@<?= session()->get('username'); ?></span><br><span style="font-size: 9pt;"><?= session()->get('role'); ?></span><br><span class="date" style="font-size: 9pt;">Masuk melalui alamat IP <?= $_SERVER['REMOTE_ADDR'] ?></span><br><span class="date" style="font-size: 9pt;">Sesi Anda akan berakhir pada <?= session()->get('expires_at'); ?></span></span>
                            </div>
