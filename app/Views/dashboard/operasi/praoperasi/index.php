...
<div class="d-flex justify-content-start align-items-center">
    <a class="fs-5 me-3 text-body-emphasis" href="<?= base_url('/operasi'); ?>"><i class="fa-solid fa-arrow-left"></i></a>
    ...
    <?php if ($previous): ?>
        <a class="fs-6 mx-2 text-body-emphasis" href="<?= site_url('operasi/praoperasi/' . $previous['id_sp_operasi']) ?>" data-bs-toggle="tooltip" data-bs-placement="bottom" data-bs-title="<?= $previous['nomor_booking']; ?> • <?= $previous['no_rm'] ?> • <?= $previous['nama_pasien']; ?>"><i class="fa-solid fa-circle-arrow-left"></i></a>
    <?php else: ?>
        <span class="fs-6 mx-2 text-body-emphasis" style="cursor: no-drop; opacity: .5;" data-bs-toggle="tooltip" data-bs-placement="bottom" data-bs-title="Tidak ada pasien operasi sebelumnya"><i class="fa-solid fa-circle-arrow-left"></i></span>
    <?php endif; ?>
    <?php if ($next): ?>
        <a class="fs-6 mx-2 text-body-emphasis" href="<?= site_url('operasi/praoperasi/' . $next['id_sp_operasi']) ?>" data-bs-toggle="tooltip" data-bs-placement="bottom" data-bs-title="<?= $next['nomor_booking']; ?> • <?= $next['no_rm'] ?> • <?= $next['nama_pasien']; ?>"><i class="fa-solid fa-circle-arrow-right"></i></a>
    <?php else: ?>
        <span class="fs-6 mx-2 text-body-emphasis" style="cursor: no-drop; opacity: .5;" data-bs-toggle="tooltip" data-bs-placement="bottom" data-bs-title="Tidak ada pasien operasi berikutnya"><i class="fa-solid fa-circle-arrow-right"></i></span>
    <?php endif; ?>
</div>
                ...
                <li class="list-group-item px-2 border-top-0 border-end-0 border-start-0 bg-body-secondary" style="--bs-bg-opacity: 0;">
                    <div class="no-fluid-content">
                        <nav class="nav nav-pills nav-fill flex-nowrap overflow-auto rounded-3 bg-gradient border p-1 transparent-blur">
                            <a class="nav-link py-1 rounded-2 text-nowrap" href="<?= base_url('operasi/spko/' . $operasi['id_sp_operasi']); ?>">SPKO</a>
                            <a class="nav-link py-1 rounded-2 text-nowrap active activeLink" href="<?= base_url('operasi/praoperasi/' . $operasi['id_sp_operasi']); ?>">Pra Operasi</a>
                            <a class="nav-link py-1 rounded-2 text-nowrap" href="<?= base_url('operasi/safety/' . $operasi['id_sp_operasi']); ?>">Keselamatan</a>
                        </nav>
                    </div>
                </li>
                <li class="list-group-item px-2 border-top-0 border-end-0 border-start-0 bg-body-secondary" style="--bs-bg-opacity: 0;">
                    <div class="no-fluid-content">
                        <nav class="nav nav-pills flex-nowrap overflow-auto rounded-3 bg-gradient border p-1 transparent-blur">
                            <?php foreach ($listRawatJalan as $list) : ?>
                                <a class="nav-link py-1 rounded-2 <?= ($activeSegment === $list['id_sp_operasi']) ? 'active activeLink' : '' ?>" href="<?= base_url('operasi/praoperasi/' . $list['id_sp_operasi']); ?>">
                                    <div class="text-center">
                                        <div class="text-nowrap lh-sm"><?= $list['nomor_registrasi']; ?></div>
                                        <div class="text-nowrap lh-sm date" style="font-size: 0.75em;"><?= $list['nomor_booking'] ?></div>
                                    </div>
                                </a>
                            <?php endforeach; ?>
                        </nav>
        ...
        <div class="no-fluid-content">
            ...
            <div>
                ...
                <div class="d-grid gap-2 d-lg-flex justify-content-lg-end mb-3">
                    <button class="btn btn-body  " type="button" onclick="window.open(`<?= base_url('/operasi/praoperasi/export/' . $operasi['id_sp_operasi']) ?>`)"><i class="fa-solid fa-print"></i> Cetak Form</button>
