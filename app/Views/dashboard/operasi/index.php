        ...
        <div class="no-fluid-content">
            <div class=" rounded">
                <div class="d-grid gap-2">
                    <button id="collapseList" class="btn btn-primary btn-sm   rounded-bottom-0" type="button" data-bs-toggle="collapse" data-bs-target="#spOperasiFormContainer" aria-expanded="false" aria-controls="spOperasiFormContainer">
            ...
            <form id="statusForm" enctype="multipart/form-data" class="modal-content bg-body-tertiary shadow-lg transparent-blur">
                ...
                <div class="modal-footer justify-content-end pt-2 pb-2" style="border-top: 1px solid var(--bs-border-color-translucent);">
                    <div class="d-flex justify-content-end">
                        <button type="submit" id="statusSubmitButton" class="btn btn-primary ">
                    ...
                    <li class="list-group-item border-top-0 pb-3 pt-3">
                        ...
                        <div>
                            <div class="d-flex flex-wrap justify-content-end gap-2 mt-2">
                                <button type="button" class="btn btn-body btn-sm  status-btn" data-id="${sp_operasi.id_sp_operasi}">
                                    <i class="fa-solid fa-gear"></i> Atur Status
                                </button>
                                <?php if (session()->get('role') == 'Admisi') : ?>
                                    <button type="button" class="btn btn-body btn-sm  " onclick="window.open('<?= base_url('operasi/spko/export') ?>/${sp_operasi.id_sp_operasi}');">
                                        <i class="fa-solid fa-print"></i> SPKO
                                    </button>
                                    <button type="button" class="btn btn-body btn-sm  " onclick="window.open('<?= base_url('operasi/praoperasi/export') ?>/${sp_operasi.id_sp_operasi}');">
                                        <i class="fa-solid fa-print"></i> Pra Operasi
                                    </button>
                                    <button type="button" class="btn btn-body btn-sm  " onclick="window.open('<?= base_url('operasi/safety/export') ?>/${sp_operasi.id_sp_operasi}');">
                                        <i class="fa-solid fa-print"></i> Keselamatan
                                    </button>
                                <?php else : ?>
                                    <button type="button" class="btn btn-body btn-sm  " onclick="window.location.href = '<?= base_url('operasi/spko') ?>/${sp_operasi.id_sp_operasi}';">
                                        <i class="fa-solid fa-circle-info"></i> SPKO
                                    </button>
                                    <button type="button" class="btn btn-body btn-sm  " onclick="window.location.href = '<?= base_url('operasi/praoperasi') ?>/${sp_operasi.id_sp_operasi}';">
                                        <i class="fa-solid fa-user-check"></i> Pra Operasi
                                    </button>
                                    <button type="button" class="btn btn-body btn-sm  " onclick="window.location.href = '<?= base_url('operasi/safety') ?>/${sp_operasi.id_sp_operasi}';">
                                        <i class="fa-solid fa-user-shield"></i> Keselamatan
                                    </button>
                                <?php endif; ?>
                                <button type="button" class="btn btn-danger btn-sm   delete-btn" data-id="${sp_operasi.id_sp_operasi}" data-name="${sp_operasi.nama_pasien}" data-date="${sp_operasi.nomor_booking}">
