                ...
                <div class="no-fluid-content">
                    <nav class="nav nav-underline flex-nowrap overflow-auto">
                        <?php foreach ($listRawatJalan as $list) : ?>
                            <a class="nav-link py-1 <?= ($activeSegment === $list['id_form_persetujuan_tindakan']) ? 'active activeLink' : '' ?>" href="<?= base_url('frmsetuju/details/' . $list['id_form_persetujuan_tindakan']); ?>">
