            ...
            <div class="modal-content bg-body-tertiary rounded-5 shadow-lg transparent-blur">
                <div class="modal-body p-4">
                    ...
                    <div class="row gx-2 pt-4">
                        ...
                        <div class="col d-grid">
                            <button type="button" class="btn btn-lg btn-danger  fs-6 mb-0 rounded-4" id="confirmDeleteBtn">Haous</button>
                        </div>
                    </div>
                </div>
            </div>
    ...
    async function fetchResep() {
        ...
        try {
            ...
            <li class="list-group-item pb-3 pt-3">
                <div class="d-flex">
                    <div class="align-self-center w-100">
                        <h5 class="card-title d-flex date justify-content-between">
                            ...
                            <span class="ms-1 align-self-center w-100 overflow-hidden"><span style="height: 1em;" class="isian-teks lh-1 fw-medium">${resep.nama_pasien}</span></span>
                        </h5>
                        <h6 class="card-subtitle mb-2">
                            <span class="isian-teks lh-1 fw-medium">${resep.dokter}</span><br>${jenis_kelamin} ${nomor_registrasi}
                        </h6>
                        <div class="card-text">
                            <div style="font-size: 0.75em;">
                                <div class="row gx-3">
                                    <div class="col-lg-6">
                                        ...
                                        <div class="mb-0 row g-1 align-items-center">
                                            ...
                                            <div class="overflow-hidden col date">
                                                <span class="isian-teks date">${resep.no_rm}</span>
                                            </div>
                                        </div>
                                        <div class="mb-0 row g-1 align-items-center">
                                            <div class="overflow-hidden col-5">
                                            ...
                                            <div class="overflow-hidden col date">
                                                <span class="isian-teks date">${resep.nomor_registrasi}</span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                ...
                <hr>
                <div class="d-grid gap-2 d-flex flex-wrap justify-content-end">
                    <button type="button" class="btn btn-body btn-sm  " onclick="window.location.href = '<?= base_url('resep/detailresep') ?>/${resep.id_resep}';">
                        <i class="fa-solid fa-circle-info"></i> Detail
                    </button>
                    <button type="button" class="btn btn-danger btn-sm   delete-btn" data-id="${resep.id_resep}" data-name="${resep.nama_pasien}" data-date="${resep.tanggal_resep}" ${status}>
