...
$tanggalRegistrasi = $sakitmata['tanggal_registrasi']; // Misalnya: "2025-01-14 15:23:45"
            ...
            <div style="padding: 1cm;">
                ...
                <div class="box">
                    <div style="padding-right: 0.25cm; padding-left: 0.25cm;">
                        ...
                        <p>Pada pemeriksaan saat ini, pasien tersebut<?= ($sakitmata['biasa'] == '1') ? ' memiliki keterangan sebagai berikut:' : ' menderita sakit mata:'; ?></p>
                        <p style="padding-left: 0.5cm; padding-right: 0.5cm;"><?= nl2br($sakitmata['keterangan']) ?></p>
