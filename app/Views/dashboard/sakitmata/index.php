            ...
            if (data.total === 0) {
                ...
                data.sakitmata.forEach(function(sakitmata) {
                    ...
                    <li class="list-group-item <?= (session()->get('role') != 'Admisi') ? 'border-top-0' : ''; ?> pb-3 pt-3">
                        ...
                        <div class="d-grid gap-2 d-flex justify-content-end">
                        <?php if (session()->get('role') != 'Admisi') : ?>
                            <button type="button" class="btn btn-body btn-sm bg-gradient " onclick="window.location.href = '<?= base_url('sakitmata/details') ?>/${sakitmata.id_keterangan_sakit_mata}';">
                        ...
                        <?php if (session()->get('role') == 'Admisi') : ?>
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end shadow-sm w-100">
                                    <li><a class="dropdown-item" href="<?= base_url('sakitmata/export') ?>/${sakitmata.id_keterangan_sakit_mata}?side=left" target="_blank">Sisi kiri</a></li>
                                    <li><a class="dropdown-item" href="<?= base_url('sakitmata/export') ?>/${sakitmata.id_keterangan_sakit_mata}?side=right" target="_blank">Sisi kanan</a></li>
                                </ul>
                            </div>
                        <?php endif; ?>
                        <?php if (session()->get('role') != 'Admisi') : ?>
