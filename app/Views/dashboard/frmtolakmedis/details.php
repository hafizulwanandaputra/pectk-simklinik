                    ...
                    <div class="no-fluid-content">
                        <nav class="nav nav-pills flex-nowrap overflow-auto rounded-3 bg-gradient border p-1 transparent-blur">
                            <?php foreach ($listRawatJalan as $list) : ?>
                                <a class="nav-link py-1 rounded-2 <?= ($activeSegment === $list['id_form_penolakan_tindakan']) ? 'active activeLink' : '' ?>" href="<?= base_url('frmtolakmedis/details/' . $list['id_form_penolakan_tindakan']); ?>">
        ...
        <div class="no-fluid-content">
            ...
            <div>
                ...
                <div class="d-grid gap-2 d-lg-flex justify-content-lg-end mb-3">
                    <button class="btn btn-body  " type="button" onclick="window.open(`<?= base_url('frmtolakmedis/export/' . $form_penolakan_tindakan['id_form_penolakan_tindakan']) ?>`)"><i class="fa-solid fa-print"></i> Cetak Form</button>
