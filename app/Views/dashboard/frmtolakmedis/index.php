        ...
        <div class="no-fluid-content">
            <div class="shadow-sm rounded">
                <div class="d-grid gap-2">
                    <button id="collapseList" class="btn btn-primary btn-sm bg-gradient shadow-sm rounded-bottom-0" type="button" data-bs-toggle="collapse" data-bs-target="#FRMTolakFormContainer" aria-expanded="false" aria-controls="FRMTolakFormContainer">
            ...
            if (data.total === 0) {
                ...
                data.form_penolakan_tindakan.forEach(function(form_penolakan_tindakan) {
                    ...
                    <li class="list-group-item border-top-0 pb-3 pt-3">
                        ...
                        <hr>
                        <div class="d-grid gap-2 d-flex flex-wrap justify-content-end">
                            <button type="button" class="btn btn-body btn-sm bg-gradient " onclick="window.location.href = '<?= base_url('frmtolakmedis/details') ?>/${form_penolakan_tindakan.id_form_penolakan_tindakan}';">
                                <i class="fa-solid fa-circle-info"></i> Detail
                            </button>
                            <button type="button" class="btn btn-danger btn-sm bg-gradient  delete-btn" data-id="${form_penolakan_tindakan.id_form_penolakan_tindakan}" data-name="${form_penolakan_tindakan.nama_pasien}" data-date="${form_penolakan_tindakan.nomor_registrasi}">
